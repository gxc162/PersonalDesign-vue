...
export const constantRoutes = [
  ...
  //   component: () => import('@/pages/product/productDetials'),
  //   hidden: true
  // },
  {
    path: '/',
    ...
    children: [{
      ...
      meta: { title: '叮叮打车', icon: 'dashboard' }
    }]
  },
  {
    path: '/map',
    ...
    children: [
      {
        ...
        meta: { title: '乘客管理', icon: 'el-icon-s-help' }
      }]
  },
  {
    path: '/waiters',
    ...
    children: [
      {
        path: 'index',
        name: 'Waiters',
        component: () => import('@/pages/waiters/index'),
